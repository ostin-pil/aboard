...
(function () {
  ...
  function mount(root, opts) {
    ...
    function makeNodeEl(n) {
      ...
      el.dataset.id = n.id;
      el.href = "Claim Detail.html?id=" + n.id;
      el.draggable = false;
    ...
    function openPopover(n) {
      ...
      popover.innerHTML = `
        ...
        ${n.dossier ? `<div class="ag-pop-row"><span>dossier</span><span class="v"><a href="Dossier.html">open →</a></span></div>` : ""}
        <div class="ag-pop-cta-row">
          <a class="ag-pop-cta" href="Claim Detail.html?id=${n.id}">open detail <span class="arrow">→</span></a>
        </div>
      `;
      // position
